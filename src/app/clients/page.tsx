        ...
        <main className="overflow-x-hidden mx-auto max-w-5xl px-4 py-4 md:py-8 md:px-6 md:py-10">
          ...
          <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button size="sm" onClick={() => window.open("/workspace/" + selectedClient.id + "?tab=deliverables&type=strategie_360", "_self")} variant="outline" className="border-[#E8912D]/25 text-[#f6c978]">Strategie</Button>
              <Button size="sm" onClick={() => window.open("/workspace/" + selectedClient.id + "?tab=deliverables&type=rapport_leadgen", "_self")} variant="outline" className="border-[#E8912D]/25 text-[#f6c978]">Rapport</Button>
              <Button size="sm" onClick={() => window.open("/workspace/" + selectedClient.id + "?tab=deliverables&type=scripts_video", "_self")} variant="outline" className="border-[#E8912D]/25 text-[#f6c978]">Scripts</Button>
