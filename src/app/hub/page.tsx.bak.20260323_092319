...
const agents: AgentCard[] = [
  {
    ...
    subtitle: "Meta Ads + Google Ads - 69+ comptes",
    description:
      "Collecte automatique Meta Ads et Google Ads. Spend, leads, CPL, ROAS, conversions et red flags.",
    icon: "AI",
    accent: "#16a34a",
    surface: "rgba(22,163,74,0.14)",
    status: "live",
    statusLabel: "Live - Meta + Google Ads",
    links: [
  ...
  {
    name: "Rapport Agent",
    subtitle: "Multi-canal - Recommandations IA - PDF/DOCX",
    description:
      "Rapports clients avec donnees Meta + Google Ads, selecteur de campagnes et recommandations IA.",
    icon: "RP",
    accent: "#16a34a",
    surface: "rgba(22,163,74,0.14)",
    status: "live",
    statusLabel: "Live - Multi-canal + IA",
    links: [{ label: "Generer", href: "/rapports" }],
  },
  {
    name: "Strategy Agent",
    subtitle: "7 phases - 11 expertises marketing",
    description:
      "Generation de strategies completes en 7 phases avec expertise marketing integree. Export DOCX/PDF.",
    icon: "SA",
    accent: "#16a34a",
    surface: "rgba(22,163,74,0.14)",
    status: "live",
    statusLabel: "Live - InnovaSoins quality",
    links: [{ label: "Strategie", href: "/strategie" }],
  },
  {
    name: "Client Workspace",
    subtitle: "7 livrables - Contexte - Historique",
    description:
      "Espace client avec generation de livrables (diagnostic, brief, resume, email, pub, social, blog).",
    icon: "CW",
    accent: "#16a34a",
    surface: "rgba(22,163,74,0.14)",
    status: "live",
    statusLabel: "Live - 7 types de livrables",
    links: [{ label: "Clients", href: "/clients" }],
  },
  {
    name: "Brainstorm AI",
    subtitle: "Chat - Idees - Creative brief",
    description:
      "Assistant IA pour brainstormer des idees marketing, creer des briefs creatifs et explorer des concepts.",
    icon: "BA",
    accent: "#16a34a",
    surface: "rgba(22,163,74,0.14)",
    status: "live",
    statusLabel: "Live - Claude AI",
  },
  {
    name: "TikTok Tracker",
    subtitle: "Organic + Paid - Video metrics",
    description:
      "Suivi des performances TikTok organiques et payantes. Vues, engagement, watch time, CTR.",
    icon: "TT",
    accent: "#fdcb6e",
  ...
  },
  {
    ...
    description:
      "Donnees organiques des reseaux sociaux. Portee, engagement, croissance des abonnes.",
    icon: "SM",
    accent: "#fdcb6e",
    surface: "rgba(253,203,110,0.13)",
    status: "soon",
  ...
  },
  {
    ...
    subtitle: "YouTube - TikTok - Meta Video",
    description:
      "Suivi des resultats de contenu video. Performance par video, engagement, ROI du contenu.",
    icon: "VA",
    accent: "#fdcb6e",
    surface: "rgba(253,203,110,0.13)",
    status: "soon",
  ...
  },
  {
    ...
    description:
      "Donnees de trafic organique, positions, Search Console et rapports SEO automatises.",
    icon: "SE",
    accent: "#a29bfe",
    surface: "rgba(162,155,254,0.13)",
    status: "planned",
    statusLabel: "Planifie Q2 2026",
  },
  {
